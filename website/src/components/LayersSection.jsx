...
const LAYERS = [
  ...
  },
  {
    ...
    sub: 'Layer 2 — LangGraph Intelligence',
    desc: 'Three role-bound agents. Analyst proposes, Risk gates with delegation tokens, Trader submits. Each agent is locked to its declared tool set by the OpenClaw registry — no cross-role tool calls possible.',
    tags: ['LangGraph', 'OpenClaw', 'Tool binding', 'HMAC tokens'],
  },
  {
