...
const BLOCK_LINES = [
  ...
  { text: '║  ❌ Check 1: FAIL — $8000 > max_order_usd $5000         ║', cls: 'attack', delay: 300 },
  { text: '║     Rule fired: trade-size-limits                       ║', cls: 'attack', delay: 200 },
  { text: '║     Rule fired: intent-token-binding                    ║', cls: 'attack', delay: 200 },
  { text: '║                                                         ║', cls: 'box',    delay: 60  },
  { text: '║  ⏭  Checks 2–5: SKIPPED (early block)                  ║', cls: 'muted', delay: 200 },
  { text: '║                                                         ║', cls: 'box',    delay: 60  },
  ...
  { text: '  Audit log entry written: decision=BLOCK, rule=trade-size-limits', cls: 'muted', delay: 200 },
]
